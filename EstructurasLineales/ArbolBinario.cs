...
namespace EstructurasLineales
{
    public class ArbolBinario<T> : Interfaz<T> where T : IComparable
    {
        ...
        public void AgregarNodoR(string value, int posicion)//El que quiero insertar, su papa, su valor
        {
            var Nodo = new Nodo<T>(value, posicion);
